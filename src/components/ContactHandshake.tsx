...
import { Send, Terminal, CornerDownLeft } from "lucide-react";
    ...
    <footer className="relative bg-black text-white py-20 px-6 md:px-16 overflow-hidden border-t border-neutral-900">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="mt-2 text-xs font-mono text-neutral-500 max-w-md leading-relaxed">
            Send a secure message directly to the edge server. Responses are dispatched within standard operational hours.
          </p>
        </div>
        ...
        <div className="mb-12 p-8 bg-red-950/20 border border-red-900/50 rounded-2xl font-sans flex flex-col gap-3 relative overflow-hidden shadow-[0_0_30px_rgba(239,68,68,0.1)]">
          {/* Pulsing Left Red Edge Accent */}
          <div className="absolute top-0 left-0 w-1.5 h-full bg-red-600 animate-pulse" />
          
          {/* Pulsing indicator light */}
          <div className="absolute top-6 right-6 flex items-center gap-1.5 font-mono text-[9px] text-red-500 uppercase tracking-widest font-semibold">
            <span className="w-2 h-2 bg-red-500 rounded-full animate-ping" />
            <span className="w-2 h-2 bg-red-500 rounded-full absolute" />
            <span>TRIGGER_ALERT</span>
          </div>

          <p className="text-sm font-semibold text-neutral-400 max-w-xl leading-relaxed">
            this page was solely to trigger Rishi Upadhyay with the following:
          </p>
          <h1 className="text-3xl md:text-5xl font-mono font-extrabold tracking-widest text-red-500 mt-2 uppercase drop-shadow-[0_0_15px_rgba(239,68,68,0.4)]">
            LAUDE GPA BADA
          </h1>
        </div>
        ...
        <div className="border-t border-neutral-900 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] font-mono text-neutral-600 tracking-wider">
          <div>© {new Date().getFullYear()} ME_PORTFOLIO. ALL RIGHTS PRESERVED.</div>
        </div>
